                    ...
                    <Table stickyHeader sx={{ minWidth: 700 }} aria-label="tabla de transferencias">
                        ...
                        {transferencias.length > 0 ? (
                            transferencias.map((t, idx) => {
                                ...
                                // Si es Manual en historial de usuario:
                                if (isManual) {
                                    return (
                                        <TableRow key={t.id || idx} hover sx={{ bgcolor: '#f1f8e9' }}> {/* Color verdecito suave para diferenciar */}
                                            <TableCell>
                                            ...
                                            <TableCell>
                                                <Chip label={t.banco} color="success" size="small" variant="outlined" />
                                            </TableCell>
                                            <TableCell>{new Date(t.fecha_carga).toLocaleDateString()}</TableCell>
                                            <TableCell>-</TableCell> {/* No hay pagador externo */}
                                            <TableCell><Chip label="Aprobado" color="success" size="small" /></TableCell>
                                            {isAdmin && <TableCell>{t.usuarios?.email}</TableCell>}
                                ...
                                // RENDER MP ESTÁNDAR (Usando componente existente)
                                return (
                                    <Transferencia 
                                        key={t.id_pago} 
                                        transferencia={t} 
