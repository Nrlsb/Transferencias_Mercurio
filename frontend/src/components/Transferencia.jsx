  ...
  return (
    <div className="transferencia-card">
      ...
      <div className="info-grid">
        ...
        <div className="info-item">
          <span>💸 Monto Neto:</span> ${transaction_details.net_received_amount}
        </div>
        <div className="info-item">
      ...
      <div className="payer-info">
        ...
        <div className="info-item">
          <span>📧 Email:</span> {payer.email}
        </div>
        <div className="info-item">
          <span>🆔 ID Usuario MP:</span> {payer.id}
        </div>
        <div className="info-item">
          <span>📄 Documento:</span> {payer.identification.type} {payer.identification.number}
        </div>
      </div>
    </div>
  );
